        ...
        doLast {
          ...
          project.exec {
            ...
            args '-c', ". ${project.ext.envdir}/bin/activate && " +
                "pip install --retries 10 --upgrade tox==3.11.1 -r ${project.rootDir}/sdks/python/build-requirements.txt -r ${project.rootDir}/sdks/python/build-requirements-linkedin.txt" +
